                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                      ...
                      >
                        ...
                        <span className="hidden xs:inline">Download Ticket</span>
                        <span className="xs:hidden">Ticket</span>
                      </a>
                      {t.used && t.certificate_issued && (
                        <a 
                          className="flex-1 px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-medium rounded-lg transition-all flex items-center justify-center gap-2 text-sm sm:text-base"
                          href={`/api/certificate-pdf?ticketId=${t.id}`}
                          download
